...
- [ ] Remaining domain modules from the concept doc, not yet started: cloud identity (Entra/Intune), monitoring, authn/authz, remote access/VPN, abstracted/prosumer networking gear
