...
- `placement-quiz` — the behavioral placement quiz, currently wired up for one module (Networking Fundamentals) — not yet a per-domain island like the rest

All domain-module islands are structurally identical to the two Phase 1 proof islands — different content, same shape — confirming the islands pattern generalizes rather than being a one-off. **All nine domain modules from the concept doc are now built — Phase 4 is complete.**
